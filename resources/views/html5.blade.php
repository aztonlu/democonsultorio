...
@foreach ($pacientes as $paciente)
  ...
  @endif
      <div class="col-sm-12">
        <div class="col-sm-6">
          ...
          <button type="button" id="xray" data-toggle="modal" data-target="#example2"> </button>
        </div>
        <div class="col-sm-6">
          <ul class="list-inline">
            <li>
            ...
            @else
              <!--<h5>AQUI DEBEN IR LOS CONCEPTOS</h5>-->
                <table class="table" id="myTable">
                  <thead>
                    <tr>
                      <th>Concepto</th>
            ...
            @else
            <!--<h5>AQUI DEBEN IR LAS CUENTAS</h5>-->
            @if(count($cuentas) == 0)
            @else    
            <table class="table" id="myTable">
            <thead>
              <tr>
              <th>Dej&oacute; a Cuenta</th>
  ...
  @extends('layouts.modalnavegador')
@endforeach
